...
<body>
  ...
  <section id="menu">
    ...
    <div class="row">
      <div class="col">
        ...
        <div class="card" style="width: 18rem;">
          ...
          <img
            src="https://media.istockphoto.com/photos/hand-takes-pizza-picture-id1218105733?b=1&k=20&m=1218105733&s=170667a&w=0&h=p4OpHL3nL2f1spQkrHhxLDcOpyFGQhqzM_htCj2nifo="
            class="card-img-top" alt="...">
          <div class="card-body">

            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet
      ...
      <div class="col">
        <div class="card" style="width: 18rem;">
          ...
          <img
            src="https://images.unsplash.com/photo-1513104890138-7c749659a591?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8aXNsYW5kJTIwdHVuYSUyMHBpenphfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
            class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card" style="width: 18rem;">
          ...
          <img
            src="https://images.unsplash.com/photo-1590947132387-155cc02f3212?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8cGl6emF8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"
            class="card-img-top" alt="...">
          <div class="card-body">
    ...
    <a href="{{url('/menu')}}"><button style="margin:3% 0% 0% 0%;"type="submit" class="btn btn-primary">View Menu</button></a>
    ...
    <div class="row cols-2">
      <div class="col-8 takeaway-content">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, lectus
          magna
          fringilla urna, porttitor</p>
        <button class="btn btn-primary btn-lg" type="button"><i class="fa-brands fa-whatsapp"></i> Whatsapp Us</button>
        <p>Terms and Conditions Applicable</p>
      </div>

      <div class="col-4">
        <img
          src="https://images.unsplash.com/photo-1423666639041-f56000c27a9a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y29udGFjdCUyMHVzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
          class="takeawayimg">
      </div>
    </div>
